...
//get nutrition rotine by pk
export const ROUTINEBYID = gql`
  query MyQuery($id: uuid!) {
    nutrition_routine_by_pk(id: $id) {
      routine_category
      created_at
      day_1
      day_10
...
export const DELETE_NUROUTINE = gql`
  mutation DELETE_NUROUTINE($id: uuid!) {
    delete_nutrition_routine_by_pk(id: $id) {
      id
    }
  }
`;
...
export const UPDATE_NODAYS = gql`
  mutation UpdateNoDays(
    ...
    update_nutrition_routine_by_pk(
      pk_columns: { id: $id }
      _set: {
        description: $description
        duration_of_routine_in_days: $duration_of_routine_in_days
